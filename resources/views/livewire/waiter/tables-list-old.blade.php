    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 myanmar-text">ဆိုင်အတွင်းရှိ စားပွဲအခြေအနေများကို ကြည့်ရှုနိုင်ပါသည်။</p>
            </div>
        ...
        <div class="flex flex-wrap gap-3 mb-8">
            ...
            <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-amber-50 text-amber-700 border border-amber-100">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6">
            @forelse($tables as $table)
                @php
                    ...
                    if ($isOccupied) {
                        $cardClass = 'bg-gradient-to-br from-rose-500 to-rose-600 text-white shadow-md ring-1 ring-rose-600 hover:shadow-lg transform hover:-translate-y-1';
                        $iconClass = 'text-rose-100';
                        $textClass = 'text-white';
                        $subTextClass = 'text-rose-100';
                        $badgeClass = 'bg-white/20 text-white backdrop-blur-sm';
                    } elseif ($isReserved) {
                        $cardClass = 'bg-gradient-to-br from-amber-400 to-amber-500 text-white shadow-md ring-1 ring-amber-500 hover:shadow-lg transform hover:-translate-y-1';
                ...
                >
                    ...
                    <div class="flex justify-between items-start w-full mb-4 relative z-10">
                        <div class="p-2 rounded-xl {{ $isOccupied || $isReserved ? 'bg-white/20' : 'bg-emerald-50' }}">
                    ...
                    <!-- Status / Action -->
                    <div class="w-full relative z-10 mt-auto pt-3 border-t {{ $isOccupied || $isReserved ? 'border-white/20' : 'border-gray-100' }}">
                        @if($isOccupied)
